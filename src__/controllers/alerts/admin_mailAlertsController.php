 ...
 * retrieves a list of all the cars that are in the database
 * search the expenditure databases for the highest mileage and check that it is greater than or equal to the mileage of the sum of the last repair plus the setting km
 *
 *
 */
