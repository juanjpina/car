        ...
        <div class="newLogin column">
            <form action="" method="post">
                <div class="pseudo column">
                    ...
                    <input type="text" maxlength="10" class=" input email<?= $error['class']; ?>" id="pseudo" placeholder="Pseudo" name="pseudo" value="">
                ...
                <div class="column">
                    ...
                    <input type="password" id="password" placeholder="mot de passe" name="password" value="">
                    <p class="message"> <?= $error['message']; ?></p>
