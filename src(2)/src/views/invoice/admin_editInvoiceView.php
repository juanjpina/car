...
<section>
    <div class="editInvoice">
        ...
        <div class="column">
            ...
            <?php } else if(!empty($selectInvoice)){?>
                    <?php echo 'hola'?>
                     <?php if(!is_null($selectInvoice)){?>
                  <?php      echo "<p>Il n'y a pas de donnés pour le véhicule " .  $_SESSION['car']['trademark'] . "</p>"; }}?>
        </div>
    </div>
</section>
